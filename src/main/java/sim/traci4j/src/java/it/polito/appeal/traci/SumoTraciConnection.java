...
import sim.traci4j.src.java.it.polito.appeal.traci.StreamLogger.StreamLoggerTyp;
...
public class SumoTraciConnection {
	 ...
	 */
	public static final String SUMO_EXE_PROPERTY = "io.sevengo.smart.traci4j.src.java.it.polito.appeal.traci.sumo_exe";
